          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div>
              ...
              <input
                ...
                placeholder="admin@enetfiber.com"
                autoComplete="email"
                required
                style={{
              ...
              <div style={{ position: 'relative' }}>
                ...
                <button type="button" onClick={() => setShowPass(v => !v)}
                  style={{
                    ...
                    background: 'none', border: 'none', cursor: 'pointer', color: '#8AAABB', padding: 0,
                  }}>
            ...
            {error && (
              <div style={{
                ...
                border: '1px solid rgba(220,38,38,0.2)', borderLeft: '3px solid #DC2626',
              }}>
                {error}
              </div>
            )}
